...
var prefix = "!"
var adminprefix = '$'
const developers = ["373543054935851009","id"]
...
var config = {
  events: [
    {type: "CHANNEL_CREATE", logType: "CHANNEL_CREATE", limit: 10, delay: 5000},
...
client.on("guildMemberAdd", member => {
  client.channels.find('id', '599591156296187918').send(` **Welcome To .. Server Khaled **  `)
});
/////////
...
/////
client.login('NjAxODA4NTM2NzQ1NDEwNTcw.XTHr7g.ZFHBcH5COaK6wPgH2YAil74RRrs');